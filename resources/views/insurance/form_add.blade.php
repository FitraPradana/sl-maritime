                    ...
                    <form action="{{ route('insurance.store') }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="policy_number" name="policy_number" value="{{ old('policy_number') }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-sm-6 col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon">
                                        <input class="form-control datetimepicker" type="text" id="inception_date" name="inception_date" onmouseout="" value="{{ old('inception_date') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="cal-icon">
                                        <input class="form-control datetimepicker" type="text" id="expiry_date" name="expiry_date" onmouseout="" value="{{ old('expiry_date') }}" required>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6 col-md-2">
                            ...
                            <div class="col-sm-6 col-md-3">
                                ...
                                </div><li class="fa fa-plus"><a href="#" data-toggle="modal" data-target="#add_broker"> Add Broker</a></i>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="table-responsive">
                                    <table id="form-dynamic" class="table table-hover table-review table-white">
                                        <tbody>
                                            <tr>
                                                <td></td>
                                                <td></td>
                                                ...
                                                <td style="text-align: right; padding-right: 30px;width: 230px">
                                                    <input class="form-control text-right" id="total_amount" name="total_amount" value="0" type="number">
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="submit-section">
                            ...
                            <button class="btn btn-primary submit-btn" type="submit" onclick="validateTgl()">Save</button>
                            <a class="btn btn-primary submit-btn m-r-10" href="{{ route('insurance_renewal_monitoring.index') }}">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
			...
			function GetDynamicTextBox(table_id) {
                ...
                '<td><input type="text" name = "DynamicTextBox" class="form-control" value = "'+rowsLength+'" readonly></td>' +
