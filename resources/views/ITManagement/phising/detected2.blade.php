<html>
<title>Sinarmas LDA Maritime</title>
<link REL="SHORTCUT ICON" HREF="http://i45.tinypic.com/1o6cqx.png">
<script type='text/javascript'>
//<![CDATA[
msg = "ALERT CYBER IT SLM !!! ";
msg = "ALERT CYBER IT SLM !!! " + msg;pos = 0;
function scrollMSG() {
...
<div id="matrix">
<b> ................   Cyber Security Awareness      ................</b></div>
<center>
...
<img src="{{ asset('/') }}template_hrsm/SLM.jpg" border="0"width="200px" height="100px">

<p id="message"><b> {+} This is CYBER ATTACK DRILL By ==> IT Department (SLM) {+} </b><br>
===========================================
<span style="color: green;">
<b><br>Hello Sir....</b></font><span style="color: lime;">
<br />
<br> <b><br>Be aware of the suspicious/unknown website source ^_^ </b>
</font>
<br />
<br>
<span style="color: Red;">
{{-- <br><b>Attention: Your password has been compromised by hackers. Please change it immediately to secure your account !!</b><br></font> --}}
<center>
<img src="{{ asset('/') }}template_hrsm/CybAttck2.jpeg" border="0"width="550px" height="320px"></center>
</center>
<div style="text-shadow: 0px 0px 5px red;">
<span style="color: white;">
<b>Attention : </b><marquee scrollamount="10" direction="left" width="50%">Your password has been compromised by hackers. Please change it immediately to secure your account
</marquee>
