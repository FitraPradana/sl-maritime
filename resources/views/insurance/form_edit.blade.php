...
@section('title', 'Update Renewal Insurance')
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <div class="page-header">
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="page-title">Edit Renewal Insurance</h3>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item">Insurance</li>
                            <li class="breadcrumb-item"><a href="#">Insurance Monitoring</a></li>
                            <li class="breadcrumb-item active">Edit Renewal Insurance</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <form id="form-add" action="{{ route('insurance.update') }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-2">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="status" name="status" value="{{ $TranInsuranceHeader->status }}"
                                    readonly>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-3">
                                    ...
                                    <div class="radio">
                                        <label>
                                            <input type="radio" class="fully_paid" id="fully_paid" name="fully_paid"
                                                value="yes" {{ $TranInsuranceHeader->fullypaid === 'yes' ? 'checked' : '' }}> YES
                                            &nbsp;<input type="radio" class="fully_paid" id="fully_paid" name="fully_paid"
                                                value="no" {{ $TranInsuranceHeader->fullypaid === 'no' ? 'checked' : '' }}> NO
                                        </label>
                                    </div>
...
@section('under_body')
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            //             $(e).find("[type='submit']").html("Update");
