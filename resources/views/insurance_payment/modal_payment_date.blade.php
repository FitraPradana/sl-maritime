        ...
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="form-payment-insurance" action="{{ route('insurance_payment.update_payment_date', $val->id) }}"
                        ...
                        <div class="submit-section">
                            {{-- <button class="btn btn-primary submit-btn" id="BtnSubmitPaymentDate"
